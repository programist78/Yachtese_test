                    ...
                    {!isSearchable ? <>
                        {userData.favoriteChats.length > 0 && (
                            <div className={c.favorite_chats}>
                                {userData.favoriteChats.map((item) => {
                                    return (
                                        <Link
                                            key={item._id}
                                            href={`${RootURLsEnum.messages}/${item._id}`}
                                            className={c.chat}>
                                            {item.user_1._id ===
                                                userData._id ? (
                                                <>
                        ...
                        <div className={c.chats}>
                            {chats.map((item) => {
                                return (
                                    <Link key={item._id} href={`${RootURLsEnum.messages}/${item._id}`} className={c.chat}>
                                ...
                                return (
                                    <Link
                                        ...
                                        {item.user_1._id === userData._id ? (
                                            <>
                                                <ImageError
                                                    src={item.user_2.avatarURL}
                                                    alt={item.user_2.userName}
                                                    className={c.photo}
                                                />
                                                <div className={c.texts}>
                                                    <h5 className={c.username}>
                                            ...
                                            <>
                                                <ImageError
                                                    src={item.user_1.avatarURL}
                                                    alt={item.user_1.userName}
                                                    className={c.photo}
                                                />
                                                <div className={c.texts}>
                                                    <h5 className={c.username}>
